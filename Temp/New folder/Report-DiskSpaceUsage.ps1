...
# input parameters
param(
	$ServerList = "C:\temp\serverslist.txt"
	, $ReportFileName = "C:\temp\FreeSpace.htm"
...
Send-MailMessage -To 			$EmailTo `
 ...
 .\Report-DiskSpaceUsage.ps1 -ServerList C:\temp1\ServerList.txt -ReportFileName C:\temp1\MC-DiskReport.htm
