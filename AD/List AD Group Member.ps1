...
Get-ADGroupMember -Identity 'Enterprise Admins' | Select-Object name, objectClass,distinguishedName | Export-CSV "C:\temp\Domain-Members.csv" -NoTypeInformation -Encoding UTF8
